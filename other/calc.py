...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_result.setStyleSheet("background-color: rgb(162, 162, 162);\n"
                                        "color: rgb(255, 255, 255);")
        self.label_result.setObjectName("label_result")
        self.btn_zero = QtWidgets.QPushButton(self.centralwidget)
        self.btn_zero.setGeometry(QtCore.QRect(0, 310, 111, 90))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        ...
        self.btn_equal.setGeometry(QtCore.QRect(109, 310, 131, 90))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.btn_equal.setStyleSheet("background-color: rgb(170, 255, 127);")
        self.btn_equal.setObjectName("btn_equal")
        self.widget = QtWidgets.QWidget(self.centralwidget)
        self.widget.setGeometry(QtCore.QRect(0, 50, 241, 261))
        ...
        self.widget1.setGeometry(QtCore.QRect(240, 50, 61, 351))
        self.widget1.setObjectName("widget1")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.widget1)
        self.gridLayout_2.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_2.setSpacing(0)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.btn_plus = QtWidgets.QPushButton(self.widget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_2.addWidget(self.btn_plus, 0, 0, 1, 1)
        self.btn_minus = QtWidgets.QPushButton(self.widget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_2.addWidget(self.btn_minus, 1, 0, 1, 1)
        self.btn_multiplication = QtWidgets.QPushButton(self.widget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_2.addWidget(self.btn_multiplication, 2, 0, 1, 1)
        self.btn_division = QtWidgets.QPushButton(self.widget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_2.addWidget(self.btn_division, 3, 0, 1, 1)
